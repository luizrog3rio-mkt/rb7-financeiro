...
// origin_tracking_rules — só muda a visão.
...
export default function Regras() {
  ...
  const novaCondicao = (grupoId: string, sellerId: string) => {
    setNovaRegra({ ...REGRA_VAZIA, group_id: grupoId === SEM_GRUPO ? '' : grupoId, seller_id: sellerId })
      ...
      {carregando ? (
        ...
        <>
          ...
          <div className="flex items-center gap-2 flex-wrap border-b border-border">
            ...
            <button
              onClick={() => { setNomeNovo(''); setModalCriar(true) }}
